...
With the advent of cloud computing, datacenters are using distributed
applications more than ever. MapReduce is used to generate over 20 petabytes
of data per day by using prodigious numbers of commodity servers
\cite{mapreduce}. Many companies use large scale clusters to perform various
computational tasks via the open-source MapReduce implementation, Hadoop
...
\section{Implementation}
  ...
  \FloatBarrier
    ...
    \texttt{WeightedVector}, the weight associated with object $D$ is set to zero in
